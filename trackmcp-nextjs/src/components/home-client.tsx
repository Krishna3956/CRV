  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[45vh] flex items-center justify-center overflow-x-hidden" aria-label="Hero section">
        {/* Subtle gradient background - Apple-like feel */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#eef3ff] via-background to-[#dce7ff] dark:from-primary/10 dark:via-background dark:to-accent/5" />
        ...
        <div className="container relative mx-auto px-4 py-8 md:py-6">
          <div className="max-w-5xl mx-auto text-center space-y-6 md:space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold animate-fade-in leading-[1.15] tracking-tight">
              <span className="gradient-text">App Store for MCP</span>
              <br />
              {/* Mobile & Desktop: Rotating text */}
              <span className="whitespace-nowrap">
                <span className="text-accent">
                  <RotatingText words={['Servers', 'Clients', 'Tools']} interval={3000} />
                </span>
              </span>
            </h1>
