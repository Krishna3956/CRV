      ...
      <section className="relative min-h-[45vh] flex items-center justify-center overflow-x-hidden" aria-label="Hero section">
        ...
        <div className="container relative mx-auto px-4 py-4 md:py-6">
          <div className="max-w-5xl mx-auto text-center space-y-6">
            ...
            <h1 className="text-5xl sm:text-5xl md:text-7xl font-extrabold animate-fade-in leading-[1.15] tracking-tight">
            ...
            <p className="text-lg sm:text-lg md:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-fade-in mt-4">
