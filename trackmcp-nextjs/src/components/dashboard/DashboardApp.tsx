...
export function DashboardApp({
  email, workspace, keys, analytics, newKey, working, error, setupRequired, setupDetails, onGenerateKey, onRevokeKey, onDismissKey, onRefresh, onCreateWorkspace, onSignOut,
}: {
  email: string; workspace: Workspace | null; keys: Key[]; analytics: Analytics | null; newKey: string; working: boolean; error: string;
  setupRequired: boolean; setupDetails: SetupDetails; onGenerateKey: () => void; onRevokeKey: (id: string) => void; onDismissKey: () => void; onRefresh: (days?: string) => void; onCreateWorkspace: (details?: SetupDetails) => void; onSignOut: () => void;
}) {
