...
type View = "overview" | "workflows" | "sessions" | "tools" | "catalog" | "clients" | "outcomes" | "reliability" | "releases" | "intent" | "settings";
...
const nav: { id: View; label: string; icon: typeof Activity; group?: string }[] = [
  ...
  { id: "intent", label: "Intent & gaps", icon: Sparkles, group: "Quality" },
