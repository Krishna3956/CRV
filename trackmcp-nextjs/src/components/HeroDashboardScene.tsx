  ...
  return (
    <div className="relative">
      ...
      <div className="relative rounded-[22px] border border-line bg-paper/70 p-2 ring-1 ring-black/[0.03] sm:p-2.5">
        <span className="absolute right-5 top-5 z-10 rounded-full border border-line bg-white/95 px-2.5 py-1 text-[11px] font-medium text-muted shadow-sm">Example data</span>
        <DashboardMock />
      </div>
    </div>
  );
