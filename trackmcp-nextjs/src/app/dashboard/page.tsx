...
export function DashboardPageContent({ onboardingMode = false, initialView = "overview" }: { onboardingMode?: boolean; initialView?: "overview" | "traces" }) {
  ...
  const loadToolQuality = async (days = "30") => {
