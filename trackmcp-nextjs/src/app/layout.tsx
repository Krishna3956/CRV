      ...
      <head>
        ...
        <script type="text/javascript" dangerouslySetInnerHTML={{
          __html: `
            ...
            })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=105344597', 'ym');

            ym(105344597, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
          `
        }} />
        <noscript><div><img src="https://mc.yandex.ru/watch/105344597" style={{position: 'absolute', left: '-9999px'}} alt="" /></div></noscript>
        {/* /Yandex.Metrika counter */}
