...
export const metadata: Metadata = {
  ...
  description: 'Understand how Track MCP collects, uses, and protects your data. Review our privacy policy for transparency and compliance.',
  openGraph: {
    title: 'Privacy Policy – Track MCP',
    description: 'Understand how Track MCP collects, uses, and protects your data. Review our privacy policy for transparency and compliance.',
...
export default function PrivacyPage() {
  // Create WebPage schema for privacy policy
  const webPageSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    name: 'Privacy Policy – Track MCP',
    description: 'Understand how Track MCP collects, uses, and protects your data. Review our privacy policy for transparency and compliance.',
    url: 'https://www.trackmcp.com/privacy',
    isPartOf: {
      '@type': 'WebSite',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'Privacy Policy',
        item: 'https://www.trackmcp.com/privacy',
      },
    ],
  }
